init -5 python:
    ...
    def AjouterEvtsVieillesseF():
        ...
        decVieillir = declencheur.Declencheur(probaVieillesse, "decVieillirH")
        decVieillir.AjouterCondition(ageSup30)
        decVieillir.AjouterCondition(estEnModeFondateur)
